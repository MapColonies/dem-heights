...
export const addProductsDictionaryMiddleware: (logger: Logger, catalogRecordsMap: Record<string, PycswDemCatalogRecord>, productMetadataFields: string[]) => GetHeightsHandler = (
    logger, 
    catalogRecordsMap,
